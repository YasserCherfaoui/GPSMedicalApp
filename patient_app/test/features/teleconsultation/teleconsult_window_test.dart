...
import 'package:patient_app/features/teleconsultation/utils/teleconsult_window.dart';
...
void main() {
  test('teleconsultWindowFor uses 15 min before and 30 min after', () {
    ...
    expect(window.windowStart, DateTime.utc(2026, 6, 16, 9, 45).toLocal());
    expect(window.windowEnd, DateTime.utc(2026, 6, 16, 11).toLocal());
  });
