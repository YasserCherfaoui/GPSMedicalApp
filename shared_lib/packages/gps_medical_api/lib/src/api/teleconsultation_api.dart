...
class TeleconsultationApi {
  ...
  Future<Response<String>> getTeleconsultLabPage({ 
    ...
    final _path = r'/call/{roomId}'.replaceAll('{' r'roomId' '}', encodeQueryParameter(_serializers, roomId, const FullType(String)).toString());
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [TeleconsultLabJoin] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TeleconsultLabJoin>> joinTeleconsultLabCall({ 
    required String roomId,
    TeleconsultLabJoinWrite? teleconsultLabJoinWrite,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/call/{roomId}/join'.replaceAll('{' r'roomId' '}', encodeQueryParameter(_serializers, roomId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(TeleconsultLabJoinWrite);
      _bodyData = teleconsultLabJoinWrite == null ? null : _serializers.serialize(teleconsultLabJoinWrite, specifiedType: _type);
    ...
    TeleconsultLabJoin? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(TeleconsultLabJoin),
      ) as TeleconsultLabJoin;
    ...
    return Response<TeleconsultLabJoin>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [TeleconsultLabSignalList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TeleconsultLabSignalList>> listTeleconsultLabSignals({ 
    required String roomId,
    ...
    final _path = r'/call/{roomId}/signals'.replaceAll('{' r'roomId' '}', encodeQueryParameter(_serializers, roomId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      r'peer_id': encodeQueryParameter(_serializers, peerId, const FullType(String)),
      if (since != null) r'since': encodeQueryParameter(_serializers, since, const FullType(int)),
      if (waitMs != null) r'wait_ms': encodeQueryParameter(_serializers, waitMs, const FullType(int)),
    };
    ...
    TeleconsultLabSignalList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(TeleconsultLabSignalList),
      ) as TeleconsultLabSignalList;
    ...
    return Response<TeleconsultLabSignalList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Parameters:
  /// * [appointmentId] 
  /// * [since] - Curseur — signaux du pair avec `seq` > since.
  /// * [waitMs] - Si > 0, le serveur attend jusqu'à `wait_ms` millisecondes qu'un signal arrive. 0 = réponse immédiate. 
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [TeleconsultSignalList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TeleconsultSignalList>> listTeleconsultationSignals({ 
    ...
    final _path = r'/teleconsultations/{appointmentId}/signals'.replaceAll('{' r'appointmentId' '}', encodeQueryParameter(_serializers, appointmentId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    TeleconsultSignalList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(TeleconsultSignalList),
      ) as TeleconsultSignalList;
    ...
    return Response<TeleconsultSignalList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [TeleconsultSignal] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TeleconsultSignal>> postTeleconsultLabSignal({ 
    required String roomId,
    required TeleconsultLabSignalWrite teleconsultLabSignalWrite,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(TeleconsultLabSignalWrite);
      _bodyData = _serializers.serialize(teleconsultLabSignalWrite, specifiedType: _type);
    ...
    TeleconsultSignal? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(TeleconsultSignal),
      ) as TeleconsultSignal;
    ...
    return Response<TeleconsultSignal>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [TeleconsultSignal] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TeleconsultSignal>> postTeleconsultationSignal({ 
    required String appointmentId,
    required TeleconsultSignalWrite teleconsultSignalWrite,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(TeleconsultSignalWrite);
      _bodyData = _serializers.serialize(teleconsultSignalWrite, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> startTeleconsultLabCall({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
