...
class MedicalRecordsApi {
  ...
  Future<Response<MedicalRecordsDocumentIdDownloadGet200Response>> medicalRecordsDocumentIdDownloadGet({ 
    ...
    MedicalRecordsDocumentIdDownloadGet200Response? _responseData;
    ...
    return Response<MedicalRecordsDocumentIdDownloadGet200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<MedicalDocument>> medicalRecordsDocumentIdGet({ 
    ...
    return Response<MedicalDocument>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<PaginatedMedicalDocuments>> medicalRecordsGet({ 
    ...
    PaginatedMedicalDocuments? _responseData;
    ...
    return Response<PaginatedMedicalDocuments>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
