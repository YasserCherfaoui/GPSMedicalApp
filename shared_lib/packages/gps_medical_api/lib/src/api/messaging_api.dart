...
class MessagingApi {
  ...
  ///
  /// Parameters:
  /// * [threadId] - Thread UUID. For the first message in a new conversation, patients may pass the specialist `doctor_id`; specialists may pass the `patient_id` (medical.patients row). The server auto-creates the thread when a shared appointment exists. 
  /// * [messageCreate] 
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Thread>> getMessagingThread({ 
    required String threadId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<Message>>> listMessagingThreadMessages({ 
    required String threadId,
    DateTime? before,
    int? limit = 50,
    CancelToken? cancelToken,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PaginatedThreads>> listMessagingThreads({ 
    int? page = 1,
    int? pageSize = 20,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    PaginatedThreads? _responseData;
    ...
    return Response<PaginatedThreads>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> markMessagingMessageRead({ 
