...
class ReviewsApi {
  ...
  Future<Response<Review>> createReview({ 
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PaginatedAppointmentReviewsForClinic] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PaginatedAppointmentReviewsForClinic>> listClinicAppointmentReviews({ 
    int? page = 1,
    int? pageSize = 20,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/clinics/me/reviews';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    PaginatedAppointmentReviewsForClinic? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PaginatedAppointmentReviewsForClinic),
      ) as PaginatedAppointmentReviewsForClinic;
    ...
    return Response<PaginatedAppointmentReviewsForClinic>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PaginatedClinicReviews] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PaginatedClinicReviews>> listClinicPublicReviews({ 
    ...
    final _path = r'/clinics/{clinicId}/reviews'.replaceAll('{' r'clinicId' '}', encodeQueryParameter(_serializers, clinicId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    PaginatedClinicReviews? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PaginatedClinicReviews),
      ) as PaginatedClinicReviews;
    ...
    return Response<PaginatedClinicReviews>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PaginatedReviews>> listDoctorReviews({ 
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> reportReview({ 
    required String reviewId,
    required ReportReviewRequest reportReviewRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(ReportReviewRequest);
      _bodyData = _serializers.serialize(reportReviewRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [Review] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Review>> updateReview({ 
    required String reviewId,
