...
class ConciergeApi {
  ...
  const ConciergeApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ConciergeCase] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ConciergeCase>> createConciergeCase({ 
    required ConciergeCaseCreate conciergeCaseCreate,
    ...
    try {
      const _type = FullType(ConciergeCaseCreate);
      _bodyData = _serializers.serialize(conciergeCaseCreate, specifiedType: _type);
    ...
    ConciergeCase? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ConciergeCase),
      ) as ConciergeCase;
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ConciergeCaseDetail] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ConciergeCaseDetail>> getConciergeCase({ 
    ...
    final _path = r'/concierge/cases/{caseId}'.replaceAll('{' r'caseId' '}', encodeQueryParameter(_serializers, caseId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ConciergeCaseDetail? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ConciergeCaseDetail),
      ) as ConciergeCaseDetail;
    ...
    return Response<ConciergeCaseDetail>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PaginatedConciergeCases>> listMyConciergeCases({ 
    int? page = 1,
    int? pageSize = 20,
    ...
    final _path = r'/concierge/me/cases';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [ConciergeCase] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ConciergeCase>> patchConciergeCase({ 
    required String caseId,
    required ConciergeCasePatch conciergeCasePatch,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(ConciergeCasePatch);
      _bodyData = _serializers.serialize(conciergeCasePatch, specifiedType: _type);
