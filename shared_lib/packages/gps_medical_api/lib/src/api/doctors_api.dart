...
class DoctorsApi {
  ...
  Future<Response<Doctor>> doctorsDoctorIdGet({
    ...
    final _path = r'/doctors/{doctorId}'.replaceAll(
      '{'
      r'doctorId'
      '}',
  ...
  Future<Response<PaginatedDoctors>> doctorsGet({
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (verifiedOnly != null)
        r'verified_only': encodeQueryParameter(
          _serializers,
          verifiedOnly,
          const FullType(bool),
        ),
  ...
  Future<Response<Credential>> doctorsMeCredentialsPost({
    ...
    try {
      _bodyData = FormData.fromMap(<String, dynamic>{
        ...
        if (issuedYear != null)
          r'issued_year': encodeFormParameter(
            _serializers,
            issuedYear,
            const FullType(int),
          ),
  ...
  Future<Response<Uint8List>> getDoctorCredentialFile({
    ...
    final _path = r'/doctors/me/credentials/{credentialId}/file'.replaceAll(
      '{'
      r'credentialId'
      '}',
      encodeQueryParameter(
