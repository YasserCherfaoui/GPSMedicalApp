...
class AvailabilityApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ClinicScheduleTemplate] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ClinicScheduleTemplate>> createClinicScheduleTemplate({ 
    required ClinicScheduleTemplateCreate clinicScheduleTemplateCreate,
    ...
    final _path = r'/clinics/me/schedule/templates';
    ...
    try {
      const _type = FullType(ClinicScheduleTemplateCreate);
      _bodyData = _serializers.serialize(clinicScheduleTemplateCreate, specifiedType: _type);
    ...
    ClinicScheduleTemplate? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ClinicScheduleTemplate),
      ) as ClinicScheduleTemplate;
    ...
    return Response<ClinicScheduleTemplate>(
      data: _responseData,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteClinicScheduleTemplate({ 
    ...
    final _path = r'/clinics/me/schedule/templates/{templateId}'.replaceAll('{' r'templateId' '}', encodeQueryParameter(_serializers, templateId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<AvailabilitySlot>>> doctorsDoctorIdAvailabilityGet({ 
    ...
    BuiltList<AvailabilitySlot>? _responseData;
    ...
    return Response<BuiltList<AvailabilitySlot>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<ScheduleException>>> doctorsMeScheduleExceptionsGet({ 
    ...
    BuiltList<ScheduleException>? _responseData;
    ...
    return Response<BuiltList<ScheduleException>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ScheduleException>> doctorsMeScheduleExceptionsPost({ 
    ...
    ScheduleException? _responseData;
    ...
    return Response<ScheduleException>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<ScheduleTemplate>>> doctorsMeScheduleTemplatesGet({ 
    ...
    BuiltList<ScheduleTemplate>? _responseData;
    ...
    return Response<BuiltList<ScheduleTemplate>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ScheduleTemplate>> doctorsMeScheduleTemplatesPost({ 
    ...
    ScheduleTemplate? _responseData;
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<ClinicAvailabilitySlot>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<ClinicAvailabilitySlot>>> getClinicServiceAvailability({ 
    ...
    final _path = r'/clinics/{clinicId}/services/{serviceId}/availability'.replaceAll('{' r'clinicId' '}', encodeQueryParameter(_serializers, clinicId, const FullType(String)).toString()).replaceAll('{' r'serviceId' '}', encodeQueryParameter(_serializers, serviceId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<ClinicAvailabilitySlot>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(ClinicAvailabilitySlot)]),
      ) as BuiltList<ClinicAvailabilitySlot>;
    ...
    return Response<BuiltList<ClinicAvailabilitySlot>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<ClinicScheduleTemplate>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<ClinicScheduleTemplate>>> listClinicScheduleTemplates({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    BuiltList<ClinicScheduleTemplate>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(ClinicScheduleTemplate)]),
      ) as BuiltList<ClinicScheduleTemplate>;
    ...
    return Response<BuiltList<ClinicScheduleTemplate>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [ClinicScheduleTemplate] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ClinicScheduleTemplate>> patchClinicScheduleTemplate({ 
    required String templateId,
    required ClinicScheduleTemplateCreate clinicScheduleTemplateCreate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
