...
class GeolocationApi {
  ...
  Future<Response<PaginatedDoctorsWithDistance>> geoDoctorsNearbyGet({
    ...
    PaginatedDoctorsWithDistance? _responseData;
    ...
    return Response<PaginatedDoctorsWithDistance>(
      data: _responseData,
  ...
  Future<Response<BuiltList<Wilaya>>> geoWilayasGet({
    ...
    BuiltList<Wilaya>? _responseData;
    ...
    return Response<BuiltList<Wilaya>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<Commune>>> geoWilayasWilayaCodeCommunesGet({
    ...
    BuiltList<Commune>? _responseData;
