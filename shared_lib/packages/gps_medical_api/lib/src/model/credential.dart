...
class CredentialTypeEnum extends EnumClass {
  ...
  static const CredentialTypeEnum councilCard = _$credentialTypeEnum_councilCard;
  @BuiltValueEnumConst(wireName: r'specialty_cert')
  static const CredentialTypeEnum specialtyCert = _$credentialTypeEnum_specialtyCert;
  @BuiltValueEnumConst(wireName: r'other')
  static const CredentialTypeEnum other = _$credentialTypeEnum_other;

  static Serializer<CredentialTypeEnum> get serializer => _$credentialTypeEnumSerializer;
  ...
  static CredentialTypeEnum valueOf(String name) => _$credentialTypeEnumValueOf(name);
}
...
class CredentialStatusEnum extends EnumClass {
  ...
  static Serializer<CredentialStatusEnum> get serializer => _$credentialStatusEnumSerializer;

  const CredentialStatusEnum._(String name): super(name);

  static BuiltSet<CredentialStatusEnum> get values => _$credentialStatusEnumValues;
  static CredentialStatusEnum valueOf(String name) => _$credentialStatusEnumValueOf(name);
}
