...
import 'package:gps_medical_api/src/api/concierge_api.dart';
...
class GpsMedicalApi {
  ...
  /// Get ConciergeApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  ConciergeApi getConciergeApi() {
    return ConciergeApi(dio, serializers);
  }
