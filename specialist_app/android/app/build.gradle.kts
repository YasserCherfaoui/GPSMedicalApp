...
android {
    ...
    defaultConfig {
        ...
        applicationId = "com.gpsmedical.specialist_app"
    ...
    productFlavors {
        create("dev") {
            ...
            manifestPlaceholders["appName"] = "Medora Spec Dev"
        }
        create("staging") {
            dimension = "default"
            applicationIdSuffix = ".staging"
            manifestPlaceholders["appName"] = "Medora Spec Stg"
        }
        create("prod") {
            dimension = "default"
            manifestPlaceholders["appName"] = "Medora Spec"
        }
    }
